    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="mt-4">
            {isOwnProfile ? (
              ...
              <Button
                ...
                className={
                  isFollowing
                    ? 'hover:bg-destructive hover:text-destructive-foreground hover:border-destructive group'
                    : ''
                }
              >
                {isFollowing ? (
      ...
      <Tabs defaultValue="posts" className="w-full">
        <TabsList className="w-full justify-start rounded-none border-b border-border bg-transparent h-12 p-0">
          <TabsTrigger
            value="posts"
            className="flex-1 rounded-none data-[state=active]:border-b-2 data-[state=active]:border-foreground data-[state=active]:shadow-none"
          >
            Posts
          </TabsTrigger>
          <TabsTrigger
