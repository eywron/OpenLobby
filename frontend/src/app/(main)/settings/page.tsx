          ...
          <Card className="bg-background border-border">
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="flex-1 w-full space-y-4">
          ...
          <Card className="bg-background border-border">
            <CardContent className="p-6 space-y-6">
              <div className="space-y-2">
                ...
                <Input value={user?.email || ""} disabled className="bg-secondary/10 text-muted-foreground" />
                <p className="text-xs text-muted-foreground">Email address cannot be changed in this version.</p>
              </div>
                ...
                {["Likes", "Comments", "Follows", "Mentions"].map((pref) => (
                  <div key={pref} className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Receive notifications for {pref.toLowerCase()}</div>
                    </div>
                  ...
                  <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                      <div className="space-y-2">
                        ...
                        <Input id="deletePassword" type="password" placeholder="Enter your password to confirm" />
                      </div>
                    </div>
                    <DialogFooter>
